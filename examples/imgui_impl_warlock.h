...
//IMGUI_IMPL_API void     ImGui_Impl_EnableDpiAwareness();
//IMGUI_IMPL_API float    ImGui_Impl_GetDpiScaleForHwnd(void* hwnd);       // HWND hwnd
//IMGUI_IMPL_API float    ImGui_Impl_GetDpiScaleForMonitor(void* monitor); // HMONITOR monitor
//
