...
//
//#include "imgui.h"
//#include "imgui_impl_warlock.h"
//
//#include "C_OS.h"
//#include "C_DisplayManager.h"
//#include "CI_Keys.h"
...
//static void ImGui_Impl_ShutdownPlatformInterface();
...
//    io.BackendPlatformName = "imgui_impl_WARLOCK";
//
//    // Our mouse update function expect PlatformHandle to be filled for the main viewport
//    ImGuiViewport* main_viewport = ImGui::GetMainViewport();
//    main_viewport->PlatformHandle = C_DisplayManager::GetInstance()->GetMainWindow()->GetHandle();
//    if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
//        ImGui_Impl_InitPlatformInterface();
//
...
//{
//    ImGui_Impl_ShutdownPlatformInterface();
//}
//
//static bool ImGui_Impl_UpdateMouseCursor()
//{
//    ImGuiIO& io = ImGui::GetIO();
...
//        C_OS::GetInstance()->ShowHardwareCursor(false);
//    }
//    else
//    {
...
//        C_OS::GetInstance()->ShowHardwareCursor(true);
//    }
//    return true;
//}
//
...
//    int mouse_x, mouse_y;
//    os->GetMouse()->GetScreenXY(mouse_x, mouse_y);
...
//    C_Display* disp = C_DisplayManager::GetInstance()->GetMainWindow();
//    io.DisplaySize = ImVec2((float)(disp->GetWidth()), (float)(disp->GetHeight()));
