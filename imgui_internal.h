...
struct ImGuiDockNode
{
    ...
    ImGuiTabBar*            TabBar;
    std::function<void(ImGuiDockNode*)>        TabBarCallbacks[ImGuiDockNodeTabBarCallback_NumCallbacks];
...
namespace ImGui
{
    ...
    IMGUI_API bool          TreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end = NULL, const ImVec2& frameSizeOffset = ImVec2(0,0));
