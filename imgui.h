...
namespace ImGui
{
    extern bool WarAllowOnlyMenuBar;
    ...
    IMGUI_API bool          TreeNodeEx(const char* label, ImGuiTreeNodeFlags flags = 0, const ImVec2& frameSizeOffset = ImVec2(0,0));
    ...
    IMGUI_API ImGuiID       DockSpaceOverViewport(ImGuiViewport* viewport = NULL, ImGuiDockNodeFlags flags = 0, const ImGuiWindowClass* window_class = NULL, ImVec2 offset = ImVec2(0, 0));
...
enum ImGuiTreeNodeFlags_
{
	...
	ImGuiTreeNodeFlags_DisableHover         = 1 << 15,
};
...
enum ImGuiCol_
{
    ...
    ImGuiCol_ButtonIconTint,
    ImGuiCol_ButtonIconTintDisabled,
    ImGuiCol_COUNT
...
enum ImGuiStyleVar_
{
    ...
    ImGuiStyleVar_FramePaddingCheckbox,// ImVec2    FramePadding
...
struct ImGuiStyle
{
    ...
    ImVec2      FramePaddingCheckbox;       // Padding within a framed rectangle (used by most widgets).
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledMultiColor(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding, ImDrawCornerFlags rounding_corners);
